...
<c:import url="/common/base.jsp">
    ...
    <c:param name="content">
        <section class="mo-4">
            ...
            <form method="post" action="TeacherSignupExecute.action" autocomplete="off">
                <div class="row border mx-3 mb-3 py-2 align-items-center rounded" id="filter">
                    <div>
                        <label class="form-label" for="teacher-id-input">教職員ID</label>
                        <input class="form-control" id="teacher-id-input" name="teacher_id" value="${teacher_id}" maxlength="10" required placeholder="教職員IDを入力してください" autocomplete="off">
                    ...
                    <div>
                        ...
                        <input type="password" class="form-control" id="teacher-password-input" name="password" maxlength="20" required placeholder="パスワードを入力してください" autocomplete="new-password">
